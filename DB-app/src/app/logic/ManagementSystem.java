...
/**
 * Created by dyachkov1997 on 15.02.17.
 */
public class ManagementSystem {
    ...
    public String getGroupNameFromId (int groupId) throws SQLException {

        PreparedStatement stmt = null;
        ResultSet rs = null;
        try {
            stmt = con.prepareStatement("SELECT groupName FROM groups " + "WHERE group_id=?");
        ...
        try {
            stmt = con.prepareStatement(
                    "INSERT INTO students " +
                            "(firstName, patronymic, surName, sex, dateOfBirth, group_id, educationYear, groupname) " +
                            "VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
